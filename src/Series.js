...
const info_movies =[
    ...
    },
    {
        ...
        original_language: "en",
        original_name: "Angel Has Fallen",
        genre_ids: [
            28
        ],
    ...
    },
    {
        ...
        original_language: "en",
        original_name: "Escape Plan: The Extractors",
        genre_ids: [
            28,
            53
        ],
...
function Movies (){
    return (
        ...
        <div>
            ...
            <Line20 titulo={'titulo1'} info={info_movies} type={'serie'}/>

            <Line20 titulo={'titulo2'} info={info_movies} type={'serie'}/>
